...
class Referee {
    public:
        ...
        enum class EventType {
            ...
            Prepared [[deprecated]],
            IndirectGoal [[deprecated]],
            ChippedGoal [[deprecated]],
            KickTimeout [[deprecated]],
            AttackerTouchedOpponentInDefenseArea [[deprecated]],
            AttackerTouchedOpponentInDefenseAreaSkipped [[deprecated]],
            BotCrashUniqueSkipped [[deprecated]],
            BotPushedBotSkipped [[deprecated]],
            DefenderInDefenseAreaPartially [[deprecated]],
            MultiplePlacementFailures [[deprecated]],
        };

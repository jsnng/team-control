...
import TeamControl.SSL.ssl_simulation_config_pb2 as ssl__simulation__config__pb2
import TeamControl.SSL.ssl_simulation_error_pb2 as ssl__simulation__error__pb2

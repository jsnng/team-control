...
/* @@protoc_insertion_point(class_definition:SSL_DetectionRobot) */ {
 public:
  ...
  SSL_DetectionRobot* New(::google::protobuf::Arena* arena = nullptr) const final {
...
/* @@protoc_insertion_point(class_definition:SSL_DetectionBall) */ {
 public:
  ...
  SSL_DetectionBall* New(::google::protobuf::Arena* arena = nullptr) const final {
...
/* @@protoc_insertion_point(class_definition:SSL_DetectionFrame) */ {
 public:
  ...
  SSL_DetectionFrame* New(::google::protobuf::Arena* arena = nullptr) const final {
